...
export default function AboutUs() {
    ...
    return (
        <div className="bg-white dark:bg-[#070707] w-full px-[20px] md:px-[72px] py-[48px] md:py-[80px] flex flex-col items-start gap-[24px]">
            <Tag>
            ...
            <div className="flex flex-col md:flex-row justify-between items-stretch gap-[24px]">
                <div className="relative w-full md:w-[32%] shrink-0 min-h-[220px] rounded-[12px] overflow-hidden bg-[#EEE] dark:bg-[#1D1D1D]">
                    <video
