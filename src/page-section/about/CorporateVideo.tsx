        ...
        <div className="bg-white dark:bg-[#070707] w-full px-[16px] md:px-[72px] py-[48px] md:py-[80px]">
            ...
            <div className="relative mt-[64px] w-full aspect-video rounded-[12px] overflow-hidden bg-[#EEE] dark:bg-[#1D1D1D] border border-[#EEE] dark:border-[#1D1D1D]">
                {playing ? (
                    ...
                    >
                        <span className="absolute inset-0 bg-white/20 transition-colors group-hover:bg-white/10" />
                        <span className="relative z-10 flex items-center justify-center w-[72px] h-[72px] md:w-[88px] md:h-[88px] rounded-full bg-white/90 group-hover:bg-white transition-colors mx-auto my-auto shadow-lg">
